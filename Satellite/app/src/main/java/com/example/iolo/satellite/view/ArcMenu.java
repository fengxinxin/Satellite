package com.example.iolo.satellite.view;
...
import com.example.iolo.satellite.R;

/**
 * Created by fengxinxin on 2015/10/19.
 */
public class ArcMenu extends ViewGroup implements View.OnClickListener {
    private static final int POS_LEFT_TOP = 0;
    private static final int POS_LEFT_BOTTM = 1;
    ...
    public void setOnMenuItemListener(OnMenuItemClickListener mMenuItemListener) {
            ...
            childView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if(mMenuItemListener != null){
                        mMenuItemListener.onClick(childView,pos);
                    }
                    menuItemAnim(pos-1);
                    changStatus();
                }
